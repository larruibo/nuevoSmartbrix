...
<html>
  <head>
    ...
    <title>Trabaja con nosotros - SmartBrix.</title>
    ...
    <div class="banner">
      ...
      <div id="ventajas" class="contenido-con-imagen" style="height: 1280px;">
        <div class="banner-imagen">
          <img src="../images/Fotos/Finales/trabaja.jpg" alt="">
          <div class="margen-contenido">
            <div class="texto-imagen">
              <h3>Trabaja con Nosotros</h3>
              <p>Si estás interesado en unirte a nuestro equipo, envíanos tus datos.</p>
            </div>
          </div>
        </div>
        <div class="contenido-vista-principal">
          <div class="margen-contenido">
            <div class="contenido-info-vista-principal">
              ...
              <div class="texto-info-vista-principal" style="left: auto; right:0;">
                <form id="contactForm" class="workForm" action="./" method="post" enctype="multipart/form-data">
